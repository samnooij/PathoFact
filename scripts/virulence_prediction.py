...
if __name__ == "__main__":
    ...
    parser.add_argument('infile', metavar='infile', type=str, help='The input file (FASTA format)')
    parser.add_argument('outfile', metavar='outfile', type=str, help='The outpufile (TSV format)')
    parser.add_argument('model', metavar='model', type=str, help='The model file (SAV format)')
